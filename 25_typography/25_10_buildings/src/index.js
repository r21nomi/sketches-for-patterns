...
const bgColor = new THREE.Color(0.09, 0.03, 0.0);
scene.background = new THREE.Color(0.65, 0.0, 0.0);
...
const createTiles = () => {
    ...
    renderTiles();
    // createTextTexture(1, "・12345678");
    createTextTexture(1, "・🔲x■=◆⚪川回");
};
...
class Tile {
    constructor(x, y, w, h, age) {
        ...
        this.ratio = 0.5 + (Math.random() * 2.0 - 1.0) * 0.08;
        this.ratio = 0.5;
