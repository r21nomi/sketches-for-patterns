...
vec3 col1 = vec3(1.0, 90.0, 239.0) / 255.0;
vec3 col2 = vec3(12.0, 186.0, 186.0) / 255.0;
vec3 col3 = vec3(6.0, 210.0, 34.0) / 255.0;
vec3 col4 = vec3(38.0, 8.0, 28.0) / 255.0;
vec3 col5 = vec3(21.0, 8.0, 17.0) / 255.0;
